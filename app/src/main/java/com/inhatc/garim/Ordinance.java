...
public class Ordinance {
    ...
    private String address2;  //시군구:: select box valuem
    ...
    public String getAddress1_address2() {

        return address1_address2;
    }

    public void setAddress1_address2 (String address1_address2) {

        this.address1_address2 = address1_address2;
    }
